  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Syrex Pro settings</TooltipContent>
      </Tooltip>
      <PopoverContent className="w-80 border-primary/20">
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-5">
            <SelectorRow
              id="pro-enabled"
              label="Enable Syrex Pro"
              description="Use Syrex Pro AI credits"
              tooltip="Uses Syrex Pro AI credits for the main AI model and Pro modes."
